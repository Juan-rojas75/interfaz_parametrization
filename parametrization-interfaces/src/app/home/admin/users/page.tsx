      ...
      <section className="relative rounded-2xl border border-secondary-200 bg-gradient-to-br from-secondary-100 to-secondary-200 p-6 sm:p-8">
        <div className="flex flex-col gap-3">
          <nav className="text-xs sm:text-sm text-primary-700/80" aria-label="Breadcrumb">
            ...
            <li>•</li>
            <li className="font-medium text-primary-900">Usuarios</li>
            </ol>
          </nav>
          <h1 className="text-left text-3xl sm:text-4xl font-bold text-primary-950">Listar usuarios</h1>
          <p className="max-w-2xl text-sm text-primary-800/80">Lista todos los usuarios del sistema.</p>
        </div>
      </section>
